...
export function HomeView({ 
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12">
      {/* High-Contrast Smooth Blue Gradient Premium Hero Banner */}
      <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-900 rounded-3xl p-6 text-white relative overflow-hidden shadow-lg border border-blue-500/10" id="home_hero_banner">
        ...
        {/* Intro greeting row with visual logo instead of owl */}
        <div className="flex flex-col items-center justify-center text-center space-y-4 mb-5">
          <SabushLogo size="lg" onDark={true} />
          <div className="space-y-1">
            <div className="inline-flex items-center space-x-1.5 bg-white/10 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-black tracking-widest text-white border border-white/20 uppercase">
              <Sparkles className="w-3.5 h-3.5 text-yellow-300 fill-yellow-300" />
              <span>O Club Oficial de Inglês</span>
            </div>
            <h2 className="text-xl font-black leading-tight tracking-tight mt-1 text-white">
              Fale Inglês com a Melhor Metodologia! 🇲🇿
            </h2>
          </div>
        </div>

        <p className="text-xs sm:text-sm text-slate-100/90 text-center leading-relaxed font-semibold">
          Bem-vindo ao <strong>Sabush English Club</strong>. Aprenda inglês prático do zero à fluência com lições intuitivas e suporte inteligente de IA, desenhado especialmente para o seu quotidiano em Moçambique.
        </p>

        {/* Clean CTA Group for 90-Day guided and exploration flows */}
